...
- Name: ui\checkbox.ui.spec.ts >> CHECKBOX UI TESTS >> @regression TC_CHECKBOX_EDGE_001 - Verify all checkboxes selection
- Location: tests\ui\checkbox.ui.spec.ts:51:7
